...
async function main() {
  ...
  console.log("🔍 Verifying Uniswap V4 contracts on", hre.network.name);
  ...
  try {
    ...
    console.log("PoolManager:", deploymentInfo.poolManager);
    console.log("BSCScan URL:", `https://testnet.bscscan.com/address/${deploymentInfo.poolManager}`);
    ...
    if (error.message.includes("Already Verified")) {
      ...
      console.log("2. Search for contract address:", deploymentInfo.poolManager);
